...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        mask_thr_binary=0.5))
# dataset settings
dataset_type = 'AdrenalDataset' # modified
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'train_ann.csv',# need to modify
        image_path=data_root + 'x/',
        label_path=data_root + 'y/',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'val_ann.csv',
        image_path=data_root + 'x/',
        label_path=data_root + 'y/',
        pipeline=train_pipeline,
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test_ann.csv',
        image_path=data_root + 'x/',
        label_path=data_root + 'y/',
        pipeline=train_pipeline,
        pre_pipeline = pre_pipeline_test,
